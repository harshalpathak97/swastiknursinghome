  ...
  return (
    <div className="py-8 px-4">
      ...
      <div className="text-center mb-16">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-neutral-dark mb-4">
      ...
      {/* Contact CTA */}
      <div className="text-center mt-16 bg-neutral-light rounded-2xl p-6 sm:p-8 md:p-12 mx-4">
        <h2 className="text-2xl sm:text-3xl font-bold text-neutral-dark mb-4 px-4">Still Have Questions?</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
          <a
            ...
            className="bg-[#25D366] hover:bg-[#20BA5A] text-white px-8 py-3 rounded-full font-semibold transition-colorsw-full sm:w-auto"
          >
            WhatsApp Us
          </a>
          <a
            href={`tel:${clinicData.clinic.phone}`}
            className="bg-primary hover:bg-primary/90 text-white px-8 py-3 rounded-full font-semibold transition-colorsw-full sm:w-auto"
          >
            Call Now: {clinicData.clinic.phone}
          </a>
          <a
            href="/contact"
            className="bg-neutral-dark hover:bg-neutral-dark/90 text-white px-8 py-3 rounded-full font-semibold transition-colorsw-full sm:w-auto"
          >
            Contact Form
          </a>
        </div>
