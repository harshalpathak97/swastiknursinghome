...
const Header = () => {
  ...
  return (
    <div className="relative w-full h-[85vh] min-h-[600px] flex items-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-20 container mx-auto px-6 sm:px-10 lg:px-16 flex flex-col items-start justify-center text-left h-full gap-6 max-w-4xl">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.1] tracking-tight text-gray-900 opacity-0 animate-fadeInUp" style={{ animationDelay: '0.1s', animationFillMode: 'forwards' }}>
            Trusted Care for <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Your Family</span>,
          </h1>
        ...
        {/* Subheadline */}
        <p className="text-base sm:text-lg md:text-xl text-gray-600 font-normal max-w-lg leading-relaxed opacity-0 animate-fadeInUp backdrop-blur-[2px]" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
        ...
        {/* CTA Button */}
        <div className="flex flex-col sm:flex-row gap-4 mt-4 opacity-0 animate-fadeInUp" style={{ animationDelay: '0.55s', animationFillMode: 'forwards' }}>
          <Button
            asChild
