...
const Speciality = () => {
  ...
  return (
    <div id="speciality" className="flex flex-col items-center gap-3 sm:gap-4 py-10 sm:py-12 md:py-16 px-3 sm:px-4 text-gray-800">
      <h1 className="text-2xl sm:text-3xl font-medium text-neutral-dark text-center">Our Specialties</h1>
      <p className="w-full sm:w-2/3 md:w-1/3 text-center text-xs sm:text-sm text-gray-600 px-4">
        Expert care in pediatrics and orthopedics for your family's health needs
      </p>
      <div className="flex flex-wrap justify-center gap-3 sm:gap-4 pt-4 sm:pt-5 w-full">
        {specialityData.map((item, index) => (
          <Link
            onClick={() => window.scrollTo(0, 0)}
            className="flex flex-col items-center text-xs cursor-pointer hover:shadow-md transition-shadow duration-200 min-w-[80px] sm:min-w-[100px] rounded-lg p-2"
            key={index}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-8 sm:mt-10 md:mt-12 w-full max-w-4xl px-2 sm:px-0">
        <div className="text-center p-3 sm:p-4 bg-neutral-light rounded-lg hover:bg-blue-100 transition-colors duration-200">
        ...
        <div className="text-center p-3 sm:p-4 bg-neutral-light rounded-lg hover:bg-green-100 transition-colors duration-200">
        ...
        <div className="text-center p-3 sm:p-4 bg-neutral-light rounded-lg hover:bg-purple-100 transition-colors duration-200">
        ...
        <div className="text-center p-3 sm:p-4 bg-neutral-light rounded-lg hover:bg-orange-100 transition-colors duration-200">
